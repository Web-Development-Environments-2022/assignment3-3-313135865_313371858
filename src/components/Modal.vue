        ...
        <b-modal id="my-modal" @ok="onRegister" @show="onReset" @hidden="onReset">Create Your Recipe !
            ...
            <b-form @submit.prevent="onRegister" @reset.prevent="onReset">
                <b-form-group id="input-group-title" label-cols-sm="3" label="Title:" label-for="title">
                    <b-form-input id="title" v-model="$v.form.title.$model" placeholder="pancake" type="text" :state="validateState('title')">
                    </b-form-input>
                ...
                <b-form-group id="input-group-image" label-cols-sm="3" label="Image URL:" label-for="image">
                    <b-form-input id="image" v-model="$v.form.image.$model" placeholder="https://pancake.jpg" type="text" :state="validateState('image')">
                    </b-form-input>
                    <b-form-invalid-feedback v-if="!$v.form.image.required">
                        recipe's image is required
                    </b-form-invalid-feedback>
                </b-form-group>
                <b-form-group id="input-group-time" label-cols-sm="3" label="Duration (minutes):" label-for="time">
                    <b-form-input id="time" v-model="$v.form.time.$model" placeholder="45" type="text" :state="validateState('time')">
                    </b-form-input>
          ...
          Insert time with numbers
                ...
                <b-form-group id="input-group-ingredients" label-cols-sm="3" label="Ingredients:"
                    ...
                    <b-form-input id="ingredients" v-model="$v.form.ingredients.$model" placeholder="sugar, eggs.." type="text"
                ...
                <b-form-group id="input-group-instructions" label-cols-sm="3" label="Instructions:"
                    ...
                    <b-form-input id="instructions" v-model="$v.form.instructions.$model" placeholder="mix the content togther" type="text"
                ...
                <b-form-group id="input-group-serving" label-cols-sm="3" label="Serving:" label-for="serving">
                    <b-form-input id="serving" v-model="$v.form.serving.$model" placeholder="4" type="text"
                        :state="validateState('serving')"></b-form-input>
          ...
          Serving amount should be in numbers
                ...
                <div>
                    ...
                    <b-form-checkbox id="vegetarian" v-model="vegetarian" name="vegetarian" value="true"
...
export default {
    ...
    methods: {
        ...
        async CreateRecipe() {
            try {
                console.log("http://localhost:3000" + "/personalRecipe")
